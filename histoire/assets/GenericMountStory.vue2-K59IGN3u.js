...
function create_fragment$2(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      add_location(div, file$2, 32, 0, 810);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
function create_else_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      attr_dev(p, "class", "error s-flum80glNey2");
      add_location(p, file$1, 125, 8, 3226);
    },
    m: function mount(target, anchor) {
...
function create_if_block(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      attr_dev(div, "class", "bar s-flum80glNey2");
      add_location(div, file$1, 72, 8, 1742);
    },
    m: function mount(target, anchor) {
      mount_component(icon0, target, anchor);
      insert_dev(target, t0, anchor);
      insert_dev(target, div, anchor);
      mount_component(segment0, div, null);
      append_dev(div, t1);
      mount_component(segment1, div, null);
      append_dev(div, t2);
      mount_component(segment2, div, null);
      append_dev(div, t3);
      mount_component(segment3, div, null);
      append_dev(div, t4);
      mount_component(segment4, div, null);
      append_dev(div, t5);
      mount_component(segment5, div, null);
      append_dev(div, t6);
      mount_component(segment6, div, null);
...
function create_fragment$1(ctx) {
  ...
  const block = {
    c: function create() {
      div = element("div");
      if_block.c();
      attr_dev(div, "class", "meter s-flum80glNey2");
      attr_dev(div, "data-testid", "meter-container");
      add_location(div, file$1, 69, 0, 1595);
    },
    l: function claim(nodes) {
      throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    },
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  function checkBreakpointAndSetSegmentSize() {
    ...
    if (conteiner && conteinerWidth && conteinerWidth > breakpoint) {
      segmentSize != "big" && $$invalidate(6, segmentSize = "big");
    } else {
      segmentSize != "small" && $$invalidate(6, segmentSize = "small");
    }
  }
  onMount(() => {
    var _a;
    if (min2 < 0 || max2 < 0 || optimum < 0)
      $$invalidate(5, error = "'min', 'max' and 'optimum' values must be greater than zero");
    if (!error && min2 >= max2)
      $$invalidate(5, error = "'min' value must be lower than 'max' value");
    if (!error && (optimum > max2 || optimum < min2))
      $$invalidate(5, error = "'optimum' value must be within the range of 'min' and 'max' values");
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("optimum" in $$props2)
      $$invalidate(9, optimum = $$props2.optimum);
    if ("value" in $$props2)
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("segmentTick" in $$props2)
      $$invalidate(8, segmentTick = $$props2.segmentTick);
    if ("breakpoint" in $$props2)
      breakpoint = $$props2.breakpoint;
    if ("segmentSize" in $$props2)
      $$invalidate(6, segmentSize = $$props2.segmentSize);
    if ("meter" in $$props2)
      $$invalidate(7, meter = $$props2.meter);
...
class Meter extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance$1, create_fragment$1, safe_not_equal, { min: 0, max: 1, optimum: 9, value: 2 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "Meter",
      options,
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-5k-300yo.js"), true ? __vite__mapDeps([0,1,2]) : void 0)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-yRrVc0D_.js"), true ? __vite__mapDeps([3,2,1,4,5,6]) : void 0)
    }
  ]
});
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-vmk9Uib8.js").then((n) => n.aT), true ? __vite__mapDeps([]) : void 0),
  "svelte4": () => __vitePreload(() => import("./vendor-vmk9Uib8.js").then((n) => n.aU), true ? __vite__mapDeps([]) : void 0)
};
const __default__ = {
  inheritAttrs: false
};
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/HomeView.vue-5k-300yo.js","assets/story-RNI75RUs.js","assets/vendor-vmk9Uib8.js","assets/StoryView.vue-yRrVc0D_.js","assets/MobileOverlay.vue2-bJEDlPIq.js","assets/BaseEmpty.vue--7c37ru8.js","assets/state-c1hrzDET.js"]
  }
